...
<div id="right">
	    ...
	    <div>
	            ...
	            <p>The code is hosted at <a href="https://forja.rediris.es/projects/cusl3-tucan/">rediris</a>
	             using <a href="http://subversion.tigris.org/">Subversion</a>.
	             To get a working copy of the development version use the following command:</p>
	            <p><code>svn co https://forja.rediris.es/svn/cusl3-tucan/trunk</code></p>
	    </div>
	    <div>
	            <h3>Bug Reporting</h3>
	            <p>Anybody can report bugs or request new features at our 
	            <a href="https://forja.rediris.es/tracker/?group_id=408">Tracker</a>. Read throughout the open issues 
	    ...
	    <div>
	            ...
	            <a href="http://code.google.com/p/build-tucan-doc/wiki/Join">join</a> the team?</p>
	            <p>There are also other areas where you could be of great help, like 
	            <a href="http://code.google.com/p/build-tucan-doc/wiki/HowToDocStrings">documentation</a> and
	            <a href="http://code.google.com/p/build-tucan-doc/wiki/HowToLocalize">localization</a>.</p>
