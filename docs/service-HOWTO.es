...
formato, parámetros de entrada/salida... etc).
...
"update"	 : Opcion para la actualizacion automatica del servicio, será un 
...
"slots"   : Número máximo de descargas anónimas simultaneas permitidas por
            este servicio.
...
Puede ser un archivo si lo usan varios plugins (descargas anónimas, 
...
3.7 - Archivo premium.accounts (opcional)
-----------------------------------------
Este archivo sólo es necesario si el servicio tiene soporte para cuentas premium.
