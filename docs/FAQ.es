...
13 - ¿ Qué pasará con Tucan después del CUSL III ?
14 - ¿ Dónde puedo encontrar más información ?


1 - ¿ Qué es Tucan ?
--------------------
 - Leer el archivo README (secciones: Descripción, Características).
...
4.1 - ¿ Cómo se instala en Linux ?
----------------------------------
 - Leer el archivo README (secciones: Instalación, Dependencias).
